---
title: Docks
description: Navigation dock components with smooth animations and interactive effects
---
...
Docks in Sync UI are built using Material-UI, Framer Motion, and React Icons:
...
All dock variants can be customized:

- **Icons**: Replace with any React Icons library icons
- **Responsive design**: Built-in mobile support with `useMediaQuery`
...
- `dockItems`: Array of objects with `icon`, `label`, and optional `group`
- `hoveredIndex`: Track which item is being hovered
- `config`: Object with `iconSize`, `buttonSize`, `gapSize`, `hoverScale`
- `themeColors`: Object with color values based on theme mode

## Dependencies

- `@mui/material` - Material-UI components
- `framer-motion` or `motion/react` - Animation library
- `react-icons/fi` - Feather Icons from React Icons
