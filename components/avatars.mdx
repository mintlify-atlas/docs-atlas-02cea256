...
### Modern Showcase
- `totalUsers` - Total number of users/contributors to display in the text (default: 60)

## Features

- Responsive design that adapts to mobile and desktop viewports
- Image loading states with skeleton fallbacks
...
Each avatar variant can be customized by modifying:
- Avatar sizes for different breakpoints
